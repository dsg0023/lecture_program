...
public class Experimental6 {
	...
	public static void main(String[] args) {
		...
		if(mem.Connect()){
			...
			file = TextToSpeechSota.getTTSFile((String)"この図のように、コミュニティメンバーから学習情報を収集するとともに",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"コミュニティ全体で共有し",(int)13,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"コミュニケーションを図る枠組みが必要となります．また，その仕組みとして",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"実世界のコミュニティ構成を反映した情報空間としてのオンラインコミュニティを",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"構築する必要があります．次のスライドからは",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"この枠組みに沿ったコミュニティごとのソーシャルラーニング支援について、紹介していこうと思います．",(int)13,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
