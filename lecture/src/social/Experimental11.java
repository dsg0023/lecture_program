...
public class Experimental11 {
	...
	public static void main(String[] args) {
		...
		if(mem.Connect()){
			...
			file = TextToSpeechSota.getTTSFile((String)"最後は",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"キャンパスにおけるそーしゃるラーニング支援です．情報交換と",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"コミュニティ形成の支援を実現するためには、様々なメンバーとのインタラクションを通して相互理解を深めることが必要となります．そこで",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			CRobotUtil.Log(TAG, "play:" + motion.play(pose,2400));
			CRobotUtil.wait(2400);
			pose = new CRobotPose();
			pose.SetPose(	new Byte[]{1,2,3,4,5,6,7,8},
							new Short[]{-384,661,-93,652,172,-1107,-141,-1}
							);
			...
			file = TextToSpeechSota.getTTSFile((String)"長谷川らの研究では学生とOB,OGがメンバーとなり",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"就職に関わる経験情報を交換し合いながら就職活動を支援するコミュニティサイトを構築しました．このサイトでは、",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			pose = new CRobotPose();
			pose.SetPose(	new Byte[]{1,2,3,4,5,6,7,8},
							new Short[]{-386,-1013,-224,1005,189,-1114,-140,3}
							);
			pose.SetTorque(	new Byte[]{1,2,3,4,5,6,7,8},
							new Short[]{100,100,100,100,100,100,100,100}
							);
			...
			pose = new CRobotPose();
			pose.SetPose(	new Byte[]{1,2,3,4,5,6,7,8},
							new Short[]{-381,-629,-322,630,369,-1114,-140,3}
							);
			pose.SetTorque(	new Byte[]{1,2,3,4,5,6,7,8},
							new Short[]{100,100,100,100,100,100,100,100}
							);
			...
			file = TextToSpeechSota.getTTSFile((String)"このサイトでは、OB,OGメンバーから就職活動経験や現在の仕事に関する情報をいくつかのテーマに分けて投稿してもらい学生のメンバーがそれらを閲覧し必要に応じてOB,OGとコミュニケーションをとることで個人的な関係を築いていきます．このように",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			CRobotUtil.Log(TAG, "play:" + motion.play(pose,2500));
			...
			file = TextToSpeechSota.getTTSFile((String)"Webテクノロジーの進展によって",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			pose = new CRobotPose();
			pose.SetPose(	new Byte[]{1,2,3,4,5,6,7,8},
							new Short[]{6,-878,-527,-236,188,551,50,2}
							);
			pose.SetTorque(	new Byte[]{1,2,3,4,5,6,7,8},
							new Short[]{100,100,100,100,100,100,100,100}
							);
			...
			file = TextToSpeechSota.getTTSFile((String)"様々なソーシャルメディアを用いて学習環境が開発されています．本日の講義は以上となります．お疲れ様でした．",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			pose = new CRobotPose();
			pose.SetPose(	new Byte[]{1,2,3,4,5,6,7,8},
							new Short[]{5,-636,-742,572,733,-4,50,4}
							);
			pose.SetTorque(	new Byte[]{1,2,3,4,5,6,7,8},
							new Short[]{100,100,100,100,100,100,100,100}
							);
			...
			CRobotUtil.Log(TAG, "play:" + motion.play(pose,3000));
