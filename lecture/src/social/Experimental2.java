...
public class Experimental2 {
	...
	public static void main(String[] args) {
		...
		if(mem.Connect()){
			...
			file = TextToSpeechSota.getTTSFile((String)"本日の講義では",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"そーしゃるラーニングについて特徴や枠組みについて説明した後に",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"コミュニティごとの、そーしゃるラーニング支援を紹介します。",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
