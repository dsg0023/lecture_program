...
public class Experimental10 {
	...
	public static void main(String[] args) {
		...
		if(mem.Connect()){
			...
			String file = TextToSpeechSota.getTTSFile((String)"そこで",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"永留らの研究では",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"研究知の共有・学び合い・洗練の足場を築くコミュニティサイトであるハイパーブログシステムというものが開発されました．ラボのメンバーは、このサイトに",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"研究知をblog形式で表現し，投稿・蓄積します。そして",(int)11,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			CRobotUtil.Log(TAG, "play:" + motion.play(pose,2600));
			CRobotUtil.wait(2600);
			pose = new CRobotPose();
			pose.SetPose(	new Byte[]{1,2,3,4,5,6,7,8},
							new Short[]{-384,661,-93,652,172,-1107,-141,-1}
							);
			...
			file = TextToSpeechSota.getTTSFile((String)"そして、blogに付けられるタグ、研究テーマ設定，研究ミーティング，システム開発によって",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"などによって構造化を行なうことで",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"タグを探索キーとして、多角的に研究知探索を行うことが可能となっています．",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"探索対象と探索手順を整理した探索スキーマを設計し提供することで蓄積ブログの探索・閲覧が促進され研究知の学び合いが促進される可能性が示唆されています．",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			CRobotUtil.Log(TAG, "play:" + motion.play(pose,11500));
			CRobotUtil.wait(11500);
