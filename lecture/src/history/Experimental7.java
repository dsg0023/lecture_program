...
public class Experimental7 {
	...
	public static void main(String[] args) {
		...
		if(mem.Connect()){
			...
			String file = TextToSpeechSota.getTTSFile((String)"あのー",(int)7,(int)10,(int)3);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"つぎに，エキスパートシステムの例として，",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"MYCINを紹介します．これは細菌感染症の診断と、",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"治療計画立案の支援をするシステムで、",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"プロダクションルールを用いた推論を行います．プロダクションルールはif-thenルールと呼ばれ，",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"もしこの４条件が、",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"当てはまるならば、",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"信頼度0.4で，細菌は、",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"シュードモナスであるといったように結果を、",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"導きだします．",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
