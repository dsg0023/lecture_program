...
public class Experimental12 {
	static final String TAG = "Experimental12";
	public static void main(String[] args) {
		...
		if(mem.Connect()){
			...
			file = TextToSpeechSota.getTTSFile((String)"例えば，このような誤りでは，学習者は大きい数から小さい数を引いている間違いを、",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"おかしています．システムは「被減数，減数の区別なく，大きい数から、",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"小さい数を引いている」という間違いを学習者に提示して，なぜ間違っているのかを、",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"認知させます．このように，ヒントや助言を与えることで，学習者の理解を、",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"促進することができます．以上が，学習工学誕生の歴史でした．本日の講義はココまでです．お疲れ様でした．",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
