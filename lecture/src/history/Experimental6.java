...
public class Experimental6 {
	static final String TAG = "Experimental6";
	public static void main(String[] args) {
		...
		if(mem.Connect()){
			...
			file = TextToSpeechSota.getTTSFile((String)"このように，当時の人工知能には限界があったため，人工知能を用いて特定の、",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"問題領域に対する解決を目指す知識工学が誕生しました．この知識工学では特定の問題領域を、",(int)13,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"解決するシステムとしてエキスパートシステムがあります．これは特定の専門分野を対象として，",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"そのエキスパートである専門家が持っている専門的知識，ノウハウ，経験則といったものを蓄積し，",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"専門家のような知的な振る舞いを実現し問題を解決します．このエキスパートシステムでは知識ベースと推論エンジンが分離されており，",(int)12,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
			...
			file = TextToSpeechSota.getTTSFile((String)"分離されていることで，知識の再利用や保守が可能となり，教育や学習の分野でも利用できるようになりました．",(int)13,(int)13,(int)5);
			if(file!=null){
				if(cplay != null){
					cplay.stop();
				}
